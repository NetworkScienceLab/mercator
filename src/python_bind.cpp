...
void embed(std::string edgelist_filename, std::string rootname_output, std::string already_inferred_parameters_filename,
           bool fast_mode, bool screen_mode, bool post_kappa, bool quiet_mode, bool validation_mode, bool clean_mode,
